...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <section className="w-full max-w-[1360px] mb-20 lg:mb-40 lg:mt-10 pt-[80px]">
      ...
      <section className="w-full max-w-[1360px] mb-20 lg:mb-40 px-5 lg:px-0">
      ...
      <section className="w-full max-w-[1360px] mb-10 lg:mb-20 px-5 lg:px-0">
        <h1 className="text-3xl lg:text-5xl font-black">Projekte</h1>
        <HoverEffect
          items={[
            {
              title: "Stripe",
